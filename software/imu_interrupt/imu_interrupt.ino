...
#define data_points 100 // how many datapoints to record in each array
...
void setup() {
    ...
    imu.configInt1(false, true, false, false, false);
    attachInterrupt(digitalPinToInterrupt(LSM_INT), callback_save_measurement, CHANGE);
    /**
    LSM6DS_RATE_12_5_HZ,
    LSM6DS_RATE_26_HZ,
    LSM6DS_RATE_52_HZ,
...
void loop() {
    ...
    */
    Serial.println(index_datapoint);
    Serial.println(data[index_datapoint - 1]);
}
